...
| Seat counts per type | Per-type (72-340) | `aircraft_data.py` | Typical 2-class configuration for each aircraft type. SWISS-specific where possible (e.g., A330-300 = 236 seats in SWISS config). |
